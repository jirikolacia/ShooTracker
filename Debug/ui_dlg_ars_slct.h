/********************************************************************************
** Form generated from reading UI file 'dlg_ars_slct.ui'
**
...
#ifndef UI_DLG_ARS_SLCT_H
#define UI_DLG_ARS_SLCT_H
...
public:
    ...
    void setupUi(QDialog *dlg_ars_slct)
    {
        if (dlg_ars_slct->objectName().isEmpty())
            dlg_ars_slct->setObjectName(QString::fromUtf8("dlg_ars_slct"));
        dlg_ars_slct->resize(750, 550);
        dlg_ars_slct->setStyleSheet(QString::fromUtf8("background-color: rgb(57, 169, 255);\n"
"\n"
"\n"
""));
        verticalLayout = new QVBoxLayout(dlg_ars_slct);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        horizontalLayout_8 = new QHBoxLayout();
        horizontalLayout_8->setObjectName(QString::fromUtf8("horizontalLayout_8"));
        PB_Attachment_back = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        label_19 = new QLabel(dlg_ars_slct);
        ...
        WEAPONID = new QLabel(dlg_ars_slct);
        ...
        Description = new QLabel(dlg_ars_slct);
        ...
        label_13 = new QLabel(dlg_ars_slct);
        ...
        PB_Stock = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        label_14 = new QLabel(dlg_ars_slct);
        ...
        PB_Silencer = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        label_15 = new QLabel(dlg_ars_slct);
        ...
        PB_Magazine = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        label_16 = new QLabel(dlg_ars_slct);
        ...
        PB_PistolGrip = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        label_17 = new QLabel(dlg_ars_slct);
        ...
        PB_Optics = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        label_18 = new QLabel(dlg_ars_slct);
        ...
        PB_Foregrip = new QPushButton(dlg_ars_slct);
...
"}"));
        ...
        retranslateUi(dlg_ars_slct);

        QMetaObject::connectSlotsByName(dlg_ars_slct);
    } // setupUi

    void retranslateUi(QDialog *dlg_ars_slct)
    {
        dlg_ars_slct->setWindowTitle(QApplication::translate("dlg_ars_slct", "Dialog", nullptr));
        PB_Attachment_back->setText(QString());
        label_19->setText(QApplication::translate("dlg_ars_slct", "Spr\303\241va p\305\231\303\255slu\305\241enstv\303\255 - v\303\275b\304\233r typu", nullptr));
        WEAPONID->setText(QString());
        Description->setText(QApplication::translate("dlg_ars_slct", "Kliknut\303\255m vyberte z nab\303\255dky typ\305\257 p\305\231\303\255slu\305\241enstv\303\255, \n"
"kter\303\275 chcete zm\304\233nit.", nullptr));
        label_13->setText(QApplication::translate("dlg_ars_slct", "Pa\305\276ba", nullptr));
        PB_Stock->setText(QString());
        label_14->setText(QApplication::translate("dlg_ars_slct", "Tlumi\304\215", nullptr));
        PB_Silencer->setText(QString());
        label_15->setText(QApplication::translate("dlg_ars_slct", "Z\303\241sobn\303\255k", nullptr));
        PB_Magazine->setText(QString());
        label_16->setText(QApplication::translate("dlg_ars_slct", "Pistol grip", nullptr));
        PB_PistolGrip->setText(QString());
        label_17->setText(QApplication::translate("dlg_ars_slct", "Optika", nullptr));
        PB_Optics->setText(QString());
        label_18->setText(QApplication::translate("dlg_ars_slct", "Foregrip", nullptr));
...
namespace Ui {
    class dlg_ars_slct: public Ui_dlg_ars_slct {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DLG_ARS_SLCT_H
